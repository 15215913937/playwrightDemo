...
input_path = 'C:\\Users\\sqn\\Desktop\\2.xls'
out_path = 'C:\\Users\\sqn\\Desktop\\new.xls'
P = 0.576
...
try:
    ...
    for i in range(1, x):
        ...
        worksheet.write(i, 2, sum)
        worksheet.write(i, 3, group_id)
        worksheet.write(i, 4, group)
        if (group_id % 14 == 0 and sheet1.cell_value(i + 1, 0) != val) or (i == x - 1):
            flag = 1
